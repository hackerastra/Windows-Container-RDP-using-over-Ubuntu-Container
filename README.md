...
3. One may have to work with the firewall part over docker container in case you are not able to access the RDP spawned during Vagrant. 
4. One have to troubleshoot in case the Windows Box is not able to connect to the internet. Hint: You may have to look into docker network part for the same. 
